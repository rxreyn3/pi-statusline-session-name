...
- Refreshes from Pi lifecycle/input events; no periodic polling loop is used.
...
The border label should update after the name changes. If another extension changes the session name at an unexpected time, run `/session-name-status refresh`.
